...
type ServerMetrics interface {
	...
	OpenConnection(name string, proxyType string, remoteAddr string)
	CloseConnection(name string, proxyType string, remoteAddr string)
...
func (noopServerMetrics) OpenConnection(string, string, string)                 {}
func (noopServerMetrics) CloseConnection(string, string, string)                {}
